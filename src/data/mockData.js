export const mockData = {
  ...
  batches: [
    { id: "BT-4091", mineral: "Lithium", supplier: "Tianqi Lithium", quantity: "500kg", eta: "2026-03-28", status: "Delayed", esg_grade: "B+", purity: "99.5%" },
    { id: "BT-5022", mineral: "Cobalt", supplier: "Glencore", quantity: "200kg", eta: "2026-04-05", status: "At-Risk", esg_grade: "C", purity: "98.2%" },
    { id: "BT-6033", mineral: "Graphite", supplier: "Syrah Resources", quantity: "1200kg", eta: "2026-03-20", status: "On-Track", esg_grade: "A", purity: "99.9%" },
    { id: "BT-7044", mineral: "Nickel", supplier: "Vale", quantity: "800kg", eta: "2026-03-22", status: "On-Track", esg_grade: "B", purity: "99.1%" },
    { id: "BT-8055", mineral: "Rare Earths", supplier: "Lynas Rare Earths", quantity: "50kg", eta: "2026-04-12", status: "At-Risk", esg_grade: "A-", purity: "99.99%" },
    { id: "BT-9066", mineral: "Lithium", supplier: "SQM", quantity: "450kg", eta: "2026-03-25", status: "Delayed", esg_grade: "B", purity: "99.3%" },
    { id: "BT-1077", mineral: "Cobalt", supplier: "Zhejiang Huayou", quantity: "300kg", eta: "2026-04-02", status: "On-Track", esg_grade: "B+", purity: "98.5%" },
    ...
    { id: "BT-3099", mineral: "Nickel", supplier: "Jinchuan Group", quantity: "1000kg", eta: "2026-04-10", status: "At-Risk", esg_grade: "C+", purity: "99.0%" },
    { id: "BT-4011", mineral: "Lithium", supplier: "Pilbara Minerals", quantity: "700kg", eta: "2026-03-30", status: "On-Track", esg_grade: "A-", purity: "99.6%" }
  ],
  // 8 Alerts for the Risk Feed
  alerts: [
    { id: "ALT-001", severity: "High", mineral: "Cobalt", cause: "Geopolitical unrest in Katanga region, Congo", action: "Find alternative supplier", affected_batches: ["BT-5022"] },
    ...
    { id: "ALT-003", severity: "High", mineral: "Nickel", cause: "Export ban rumors from Indonesia", action: "Increase domestic safety stock", affected_batches: ["BT-3099"] },
    ...
    { id: "ALT-006", severity: "High", mineral: "Lithium", cause: "Labor strike at Antofagasta processing plant", action: "Source from domestic recycler", affected_batches: ["BT-9066"] },
    ...
    { id: "ALT-008", severity: "Low", mineral: "Nickel", cause: "Currency fluctuation affecting spot price", action: "Review hedging strategy", affected_batches: ["BT-7044"] }
  ],
